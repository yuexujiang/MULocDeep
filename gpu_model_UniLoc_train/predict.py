...
def main():
    ...
    for foldnum in range(8):
        ...
        model_small.load_weights('./gpu_model_UniLoc_train/fold' + str(foldnum) + '_big_lv1_acc-weights.hdf5')
    ...
    cutoff = np.array([[0.5, 0.5, 0.5, 0.4, 0.5, 0.1, 0.1, 0.5],
                      [0.5, 0.5, 0.2, 0.5, 0.1, 0.4, 0.5, 0.5],
                      [1, 0.5, 1, 1, 1, 1, 1, 1],
                      [0.5, 0.5, 0.5, 0.5, 0.5, 1, 1, 1],
                      [0.5, 0.5, 0.1, 0.5, 0.5, 0.3, 1, 1],
                      [0.5, 0.5, 0.5, 0.5, 0.5, 1, 1, 1],
                      [0.4, 0.5, 0.5, 0.3, 0.5, 1, 1, 1],
                      [0.1, 0.1, 0.5, 0.5, 1, 1, 1, 1],
                      [0.3, 1, 1, 1, 1, 1, 1, 1],
                      [0.3, 1, 1, 1, 1, 1, 1, 1]])
